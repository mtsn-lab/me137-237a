...
\subtitle{Lecture 4A: Applied Computational Fluid Dynamics (CFD)}
...
%		% Commands to include a figure:
		\begin{itemize}
			\item Define the computational methods used for analyzing airflow in data center hall.
			\item Use finite difference and finite volume methods to analyze a canonical flow problem.
		\end{itemize}		
	\end{frame}
}
...
\smallframetitle
\begin{frame}
	\frametitle{Seminar 1}
		\begin{itemize}
			\item Dr. Imran Latif. Johnson Controls International (JCI)
			\item Title: From Chip to Chiller: LLM Agents as the Next Efficiency Lever in AI Data Centers
			\item Date: Wednesday, 9/16/26
			\item Time: 9:00 am (Berkeley Time)
			\item Location: Etcheverry Hall 3110
...
\smallframetitle
\begin{frame}
	\frametitle{\href{https://datahub.berkeley.edu/user-redirect/git-pull?repo=https://github.com/mtsn-lab/me137-237a&subPath=examples/computationalMethodsInCFD.ipynb}{Computational Methods in CFD}}
	
Derivation comes from Ref.\cite{ferziger2002computational}.
\end{frame}
}
...
\smallframetitle
\begin{frame}
	\frametitle{\href{https://datahub.berkeley.edu/user-redirect/git-pull?repo=https://github.com/mtsn-lab/me137-237a&subPath=examples/cfdFiniteDifferenceMethodCavityLid.ipynb}{Finite Difference: Lid Driven Cavity}}
		\begin{figure}
			\includegraphics[width=0.5\textwidth]{../figures/2D-lid-driven-cavity_Re_200.pdf}
%			\vspace{-0.5cm}
%		 \caption{}
		 \caption{Compare with Figure 7.8 from Ref.\cite{ferziger2002computational}.}
		\end{figure}
\end{frame}
}
...
\smallframetitle
\begin{frame}
	\frametitle{\href{https://datahub.berkeley.edu/user-redirect/git-pull?repo=https://github.com/mtsn-lab/me137-237a&subPath=examples/cfdFiniteVolumeMethodCavityLid.ipynb}{Finite Volume: Lid Driven Cavity}}
		\begin{figure}
			\includegraphics[width=0.5\textwidth]{../figures/2D-lid-driven-cavity-finite-volume_Re_200.pdf}
%			\vspace{-0.5cm}
%		 \caption{}
		 \caption{Compare with Figure 7.8 from Ref.\cite{ferziger2002computational}.}
		\end{figure}
...
\smallframetitle
\begin{frame}
	\frametitle{\href{https://datahub.berkeley.edu/user-redirect/git-pull?repo=https://github.com/mtsn-lab/me137-237a&subPath=examples/cfdFiniteDifferenceBuoyancyCavity.ipynb}{Finite Difference: Buoyance-driven Cavity}}
		\begin{figure}
