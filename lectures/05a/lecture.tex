...
\subtitle{Lecture 5A: Liquid Cooling \& Advanced Heat Transfer}
...
%		% Commands to include a figure:
		\begin{itemize}
			\item Define the Blasius and Polhausen equations, which are used for microelectronics cooling.
			\item Solve the Blasius and Polhausen equations.
		\end{itemize}		
	\end{frame}
}
...
In Project 3, you will analyze a conduction-convection problem. For this you will need to know the basics of CFD and boundary layer theory. You will use ANSYS Fluent.
...
We would like to remind you that you are required to follow the report template. Part of the purpose of the projects is for you to have professional examples of your work.
