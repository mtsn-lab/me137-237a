...
\subtitle{Lecture 1B: The Modern Data Center Ecosystem; Thermodynamics}
...
%			\item Define different data center architectures
			\item Apply first and second law analysis to a data center rack
			\item Analyze a data center cooling tower using psychrometric principles
		\end{itemize}		
	\end{frame}
}
