...
\subtitle{Lecture 2C: Heat Transfer}
...
%		% Commands to include a figure:
		\begin{itemize}
			...
			\item Psychrometrics and \textbf{Heat Transfer}
...
%		% Commands to include a figure:
		\begin{itemize}
			\item Introduce Project 1
			\item Define heat exchanger effectiveness
		\end{itemize}		
	\end{frame}
}
...
\smallframetitle
\begin{frame}
	\frametitle{Project 1: Properties}
...
\smallframetitle
\begin{frame}
	\frametitle{\href{https://datahub.berkeley.edu/user-redirect/git-pull?repo=https://github.com/mtsn-lab/me137-237a&subPath=examples/heatExchangerEffectiveness.ipynb}{Heat Exchanger Effectiveness}}
		\begin{figure}
			\includegraphics[width=0.4\textwidth]{../figures/inropera2007introduction-fig-11-8.pdf}
%			\vspace{-0.5cm}
		 \caption{Temperature distributions for a counterflow heat exchanger (Figure 11.8 in Ref. \cite{bergman2011introduction}).}
		\end{figure}
...
\begin{frame}
	\frametitle{\href{https://datahub.berkeley.edu/user-redirect/git-pull?repo=https://github.com/mtsn-lab/me137-237a&subPath=examples/heatExchangerEffectiveness.ipynb}{Heat Exchanger Effectiveness}}
		\begin{figure}
			\includegraphics[width=0.7\textwidth]{../figures/inropera2007introduction-fig-11-9.pdf}
%			\vspace{-0.5cm}
		 \caption{(a) $C_h >> C_c$ and (b) $C_h << C_c$, (c) A counterflow heat exchanger with equivalent fluid heat capacities ($C_h = C_c$)  (Figure 11.9 in Ref. \cite{bergman2011introduction}).}
		\end{figure}
...
\begin{frame}
	\frametitle{
		\href{https://datahub.berkeley.edu/user-redirect/git-pull?repo=https://github.com/mtsn-lab/me137-237a&subPath=examples/counterFlowHeatExchangerExample.ipynb}{Counter-flow Heat Exchanger Effectiveness}
	}
		\begin{figure}
			\includegraphics[width=0.7\textwidth]{../figures/epsilon_ntu_curve.pdf}
%			\vspace{-0.5cm}
%		 \caption{(a) $C_h >> C_c$ and (b) $C_h << C_c$, (c) A counterflow heat exchanger with equivalent fluid heat capacities ($C_h = C_c$)  (Figure 11.9 in Ref. \cite{bergman2011introduction}).}
		\end{figure}
